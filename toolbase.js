...
tools.add({
    ...
    simpleDescription: {
        de: "MD5-Hash eines Textes berechnen",
        en: "Calculate MD5 hash of a text"
    },
    argsOld: {
        en: "inputString",
        de: "eingabeText"
    ...
    args: [
        {
            ...
            "label_de": "Text",
            "type": "text",
            "desc_en": "The text to calculate the MD5 hash for",
            "desc_de": "Der Text, dessen MD5-Hash berechnet werden soll"
        }
    ],
    tags: ["TAGS.TEXT"],
    hideInToolbox: false,
    hideOnSimpleMode: false,
    tests: () => {
        tools.expect(md5("")).toBe("d41d8cd98f00b204e9800998ecf8427e");
        tools.expect(md5("a")).toBe("0cc175b9c0f1b6a831c399e269772661");
        tools.expect(md5("abc")).toBe("900150983cd24fb0d6963f7d28e17f72");
        tools.expect(md5("message digest")).toBe("f96b697d7cb7938d525a2f31aaf161d0");
        tools.expect(md5("hello world")).toBe("5eb63bbbe01eeed093cb22bb8f5acdc3");
    }
})
